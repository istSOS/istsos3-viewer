            ...
            default: {
                ...
                switch (action.type) {
                    ...
                    case 'FETCH_SENSORS_OK':
                        let filtered = action.json.data.filter((sensor)=>{
                            if(
                                sensor.hasOwnProperty('sampled_foi')
                                && sensor.sampled_foi.shape
                            ){
                                return true;
                            }
                            return false;
